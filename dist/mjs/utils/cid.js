...
export default class CID extends Multibase {
     ...
     */
    static fromHash(bytes, size, type = CID_TYPES.RAW) {
    ...
    toBytes() {
        if (this.type === CID_TYPES.BRIDGE) {
            ...
            return concatBytes(this._getPrefixBytes(), this.hash.fullBytes, sizeBytes);
        }
 ...
 */
export function encodeCid(hash, size, type = cidTypeRaw, hashType = mhashBlake3Default) {
